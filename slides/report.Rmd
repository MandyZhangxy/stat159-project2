...
## Ridge
We perform ridge regresssion on the centered Credit training data, and obtain the following result.The best lambda equals `r ridge_best_lambda`, and the test mse is `r ridge_test_mse`.
